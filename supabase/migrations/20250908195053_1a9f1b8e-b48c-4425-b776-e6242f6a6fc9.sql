...
-- Also update the auth redirect URL in the signup function
-- This ensures email confirmation redirects to Plans page
UPDATE auth.config 
SET site_url = CASE 
  WHEN site_url IS NULL OR site_url = '' THEN 'https://preview--appetite-amplifier.lovable.app'
  ELSE site_url
END;