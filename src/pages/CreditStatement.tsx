    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Créditos Expirados</CardTitle>
              <Calendar className="h-4 w-4 text-red-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-red-600">{totalExpired}</div>
              <p className="text-xs text-muted-foreground">
                Créditos que venceram
              </p>
            </CardContent>
          </Card>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {isExpired(purchase.expiration_date) && (
        ...
        <Card className="mt-8">
          ...
          <CardContent className="space-y-4">
            <div className="text-sm text-muted-foreground space-y-2">
              ...
              <p>
                <strong>Consumo:</strong> Os créditos são consumidos sempre da compra mais antiga primeiro (FIFO - First In, First Out).
              </p>
              <p>
                <strong>Créditos Gratuitos:</strong> Novos usuários recebem 2 créditos gratuitos válidos por 30 dias.
              </p>
              <p>
                <strong>Créditos Expirados:</strong> Créditos que passaram da data de vencimento não podem mais ser utilizados.
              </p>
            </div>
          </CardContent>
        </Card>
